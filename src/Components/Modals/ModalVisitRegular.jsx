...
const handleSubmit = (event) => {
    ...
    console.log("Datos enviados:", userDataVisit);
    handleClose(); 
};
        ...
        >
            ...
            >
                ...
                <Box sx={{ width: "100%", height: "auto",}}>
                    <form onSubmit={(e) => {handleSubmit(e), handleClose()}} style={{display: "flex", flexDirection: 'column', justifyContent: "center", alignItems: "center"}} >
